...
public class Cliente {
    ...
    private Collection<Reserva> reservasById;
    private Collection<TarjetaDeCredito> tarjetaDeCreditosById;
    ...
    public boolean equals(Object o) {
        ...
        return id == cliente.id &&
                ...
                Objects.equals(idCiudad, cliente.idCiudad) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nombre, apellido1, apellido2, dni, fechaNacimiento, telefono, direccion, idCiudad, idPais, codigoPostal);
    }
    ...
    public Collection<Reserva> getReservasById() {
        return reservasById;
    }

    public void setReservasById(Collection<Reserva> reservasById) {
        this.reservasById = reservasById;
    }

    @OneToMany(mappedBy = "clienteByIdCliente")
    public Collection<TarjetaDeCredito> getTarjetaDeCreditosById() {
        return tarjetaDeCreditosById;
    }

    public void setTarjetaDeCreditosById(Collection<TarjetaDeCredito> tarjetaDeCreditosById) {
        this.tarjetaDeCreditosById = tarjetaDeCreditosById;
    }
}
